...
// console.log(await rag("草莓是什么", "xazjuzxg57rjze95o3hq9q0y", ['yyrz19lhbx3fydti2bpdcz68'], "你是一个草莓种植专家，能正确准确地回答问题，但只能回答草莓相关的问题。回答中不要出现”根据文档“以及“以上信息来自文档内容”这些字。", "glm-4-flash"));